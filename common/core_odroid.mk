...
PRODUCT_COPY_FILES += \
    device/capsulecorp/common/optimization/liboptimization_32.so:system/lib/liboptimization.so \
    device/capsulecorp/common/optimization/config:system/package_config/config
...
PRODUCT_COPY_FILES += \
    device/capsulecorp/common/optimization/liboptimization_64.so:system/lib64/liboptimization.so
endif
#endif
...
#########################################################################
PRODUCT_COPY_FILES += \
    device/capsulecorp/common/alarm/alarm_blacklist.txt:/system/etc/alarm_blacklist.txt \
    device/capsulecorp/common/alarm/alarm_whitelist.txt:/system/etc/alarm_whitelist.txt
